...
VALUES 
  ...
  /* Show candidate name, score with two decimal places. Order by higher score */
  SELECT c.name, TO_CHAR((2*s.math + 3*s.specific +5*s.project_plan)/10.0,'FM99999.00') as avg FROM score s
