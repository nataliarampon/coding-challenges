...
/* Show product name, provider name, and category name for products provided by 'Sansul SA' from the 'Imported' category */
SELECT products.name, providers.name, categories.name FROM products
  LEFT JOIN categories ON categories.id = products.id_categories
  LEFT JOIN providers ON providers.id = products.id_providers
